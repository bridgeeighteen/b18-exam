...
?>
                ...
                <div class="page page-narrow mx-auto">
                    <h2 class="page-title">信息登记</h2>
                    <p class="page-subtitle">在正式开始测试前，请填写这些基本信息以便我们核查邀请码使用情况。请记住，将邀请码转让给他人是绝对禁止的，这会导致账号被封禁。</p>
                    <div class="card form-card mt-4">
                        <div class="card-body">
                            <form action="exam.php" method="post">
                                ...
                                <div class="form-section" id="turnstile"></div>
