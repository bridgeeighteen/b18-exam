                ...
                <div class="col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="<?php echo htmlspecialchars(ANNOUCEMENT_LINK); ?>" class="btn btn-primary">了解详情</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="javascript:location.href = 'mailto:' + ['<?php echo htmlspecialchars(ADMIN_EMAIL_NAME); ?>','<?php echo htmlspecialchars(ADMIN_EMAIL_DOMAIN); ?>'].join('@')" class="btn btn-primary">去发信</a>
                    </div>
                  </div>
                </div>
              </div>
